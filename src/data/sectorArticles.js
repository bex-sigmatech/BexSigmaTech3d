...
export const SECTOR_ARTICLES = {
  ...
  cloud: {
    ...
    services: [
      ...
      { title: 'Real-Time IoT & Telemetry Sync', subtitle: 'Zero-Latency Data Pipeline', desc: 'Zero-latency telemetry aggregation, live websockets, and distributed cloud database architectures.', image: '/track_me_logo.jpg', badge: 'TELEMETRY' },
    ],
